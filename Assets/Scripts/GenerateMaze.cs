...
public class GenerateMaze : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log(playerObj == null ? "Player not found!" : "Player found and active!");
    ...
    void AddNPCs()
    {
        ...
        npc1.GetComponent<ControlNPCGaurd>().guardType = ControlNPCGaurd.GUARD_TYPE.CHASER;
        //npc1.GetComponent<ControlNPCGuard>().player = GameObject.Find("player");
        npc1.GetComponent<ControlNPCGaurd>().player = GameObject.Find("Player");
    }
}
